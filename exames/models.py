...
from django.utils.safestring import mark_safe # indica para o django que uma string é código HTML
from secrets import token_urlsafe # gerador de token seguro para a URL
